...
<tr><th>Scouter Name</th><th>Match Number</th><th>No Show</th><th>Starting Position</th><th>Auto - Baseline</th><th>Auto - Switch Places</th><th>Auto - Scale Places</th><th>Auto - Switch Drops</th><th>Auto - Scale Drops</th><th class="unsortable">Auto - Notes</th><th>Teleop - Switch Places</th><th>Teleop - Scale Places</th><th>Teleop - Switch Drops</th><th>Teleop - Scale Drops</th><th>Teleop - Exchange Visits</th><th class="unsortable">Teleop - Notes</th><th>Teleop - Boost Used</th><th>Teleop - Force Used</th><th>Teleop - Levitate Used</th><th>Climb</th><th>Died On Field</th><th class="unsortable">General Notes</th><?php if ($showHiddenData) echo "<th>No Alliance</th>" ?></tr>
<?php
